...
"")
        ...
        QWidget.setTabOrder(self.pushButton, self.lineEdit_7)
        ...
        QWidget.setTabOrder(self.lineEdit_5, self.comboBox_3)
        QWidget.setTabOrder(self.comboBox_3, self.comboBox_4)
        QWidget.setTabOrder(self.comboBox_4, self.pushButton_23)
        QWidget.setTabOrder(self.pushButton_23, self.pushButton_24)
        QWidget.setTabOrder(self.pushButton_24, self.pushButton_2)
        QWidget.setTabOrder(self.pushButton_2, self.comboBox_7)
        QWidget.setTabOrder(self.comboBox_7, self.lineEdit_11)
        QWidget.setTabOrder(self.lineEdit_11, self.lineEdit_10)
        QWidget.setTabOrder(self.lineEdit_10, self.lineEdit_8)
        QWidget.setTabOrder(self.lineEdit_8, self.lineEdit_9)
        QWidget.setTabOrder(self.lineEdit_9, self.lineEdit_13)
        QWidget.setTabOrder(self.lineEdit_13, self.comboBox_5)
        QWidget.setTabOrder(self.comboBox_5, self.comboBox_6)
        QWidget.setTabOrder(self.comboBox_6, self.pushButton_25)
        QWidget.setTabOrder(self.pushButton_25, self.pushButton_26)
        QWidget.setTabOrder(self.pushButton_26, self.comboBox_9)
        QWidget.setTabOrder(self.comboBox_9, self.comboBox_8)
        QWidget.setTabOrder(self.comboBox_8, self.doubleSpinBox)
        QWidget.setTabOrder(self.doubleSpinBox, self.doubleSpinBox_2)
        QWidget.setTabOrder(self.doubleSpinBox_2, self.pushButton_28)
        QWidget.setTabOrder(self.pushButton_28, self.comboBox_11)
        QWidget.setTabOrder(self.comboBox_11, self.comboBox_10)
        QWidget.setTabOrder(self.comboBox_10, self.doubleSpinBox_3)
        QWidget.setTabOrder(self.doubleSpinBox_3, self.doubleSpinBox_4)
        QWidget.setTabOrder(self.doubleSpinBox_4, self.pushButton_27)
        QWidget.setTabOrder(self.pushButton_27, self.pushButton_3)
        QWidget.setTabOrder(self.pushButton_3, self.lineEdit_12)
        QWidget.setTabOrder(self.lineEdit_12, self.pushButton_29)
        QWidget.setTabOrder(self.pushButton_29, self.pushButton_4)
        QWidget.setTabOrder(self.pushButton_4, self.lineEdit_16)
        QWidget.setTabOrder(self.lineEdit_16, self.lineEdit_14)
        QWidget.setTabOrder(self.lineEdit_14, self.lineEdit_15)
        QWidget.setTabOrder(self.lineEdit_15, self.pushButton_30)
        QWidget.setTabOrder(self.pushButton_30, self.pushButton_31)
        QWidget.setTabOrder(self.pushButton_31, self.pushButton_5)
        QWidget.setTabOrder(self.pushButton_5, self.comboBox_12)
        QWidget.setTabOrder(self.comboBox_12, self.lineEdit_17)
        QWidget.setTabOrder(self.lineEdit_17, self.lineEdit_18)
        QWidget.setTabOrder(self.lineEdit_18, self.pushButton_32)
        QWidget.setTabOrder(self.pushButton_32, self.pushButton_33)
        QWidget.setTabOrder(self.pushButton_33, self.pushButton_6)
        QWidget.setTabOrder(self.pushButton_6, self.lineEdit_22)
        QWidget.setTabOrder(self.lineEdit_22, self.pushButton_36)
        QWidget.setTabOrder(self.pushButton_36, self.lineEdit_23)
        QWidget.setTabOrder(self.lineEdit_23, self.tableWidget_2)
        QWidget.setTabOrder(self.tableWidget_2, self.pushButton_7)
        QWidget.setTabOrder(self.pushButton_7, self.lineEdit_19)
        QWidget.setTabOrder(self.lineEdit_19, self.pushButton_35)
        QWidget.setTabOrder(self.pushButton_35, self.pushButton_34)
        QWidget.setTabOrder(self.pushButton_34, self.pushButton_8)
        QWidget.setTabOrder(self.pushButton_8, self.lineEdit_20)
        QWidget.setTabOrder(self.lineEdit_20, self.pushButton_37)
        QWidget.setTabOrder(self.pushButton_37, self.pushButton_9)
        QWidget.setTabOrder(self.pushButton_9, self.lineEdit_21)
        QWidget.setTabOrder(self.lineEdit_21, self.tableWidget_3)
        QWidget.setTabOrder(self.tableWidget_3, self.pushButton_10)
        QWidget.setTabOrder(self.pushButton_10, self.comboBox_13)
        QWidget.setTabOrder(self.comboBox_13, self.lineEdit_24)
        QWidget.setTabOrder(self.lineEdit_24, self.lineEdit_25)
        QWidget.setTabOrder(self.lineEdit_25, self.pushButton_40)
        QWidget.setTabOrder(self.pushButton_40, self.lineEdit_26)
        QWidget.setTabOrder(self.lineEdit_26, self.pushButton_39)
        QWidget.setTabOrder(self.pushButton_39, self.pushButton_38)
        QWidget.setTabOrder(self.pushButton_38, self.pushButton_11)
        QWidget.setTabOrder(self.pushButton_11, self.comboBox_14)
        QWidget.setTabOrder(self.comboBox_14, self.comboBox_15)
        QWidget.setTabOrder(self.comboBox_15, self.lineEdit_28)
        QWidget.setTabOrder(self.lineEdit_28, self.pushButton_43)
        QWidget.setTabOrder(self.pushButton_43, self.lineEdit_30)
        QWidget.setTabOrder(self.lineEdit_30, self.pushButton_42)
        QWidget.setTabOrder(self.pushButton_42, self.pushButton_41)
        QWidget.setTabOrder(self.pushButton_41, self.lineEdit_27)
        QWidget.setTabOrder(self.lineEdit_27, self.pushButton_44)
        QWidget.setTabOrder(self.pushButton_44, self.pushButton_12)
        QWidget.setTabOrder(self.pushButton_12, self.comboBox_18)
        QWidget.setTabOrder(self.comboBox_18, self.comboBox_16)
        QWidget.setTabOrder(self.comboBox_16, self.comboBox_17)
        QWidget.setTabOrder(self.comboBox_17, self.comboBox_19)
        QWidget.setTabOrder(self.comboBox_19, self.comboBox_20)
        QWidget.setTabOrder(self.comboBox_20, self.pushButton_45)
        QWidget.setTabOrder(self.pushButton_45, self.tableWidget_4)
        QWidget.setTabOrder(self.tableWidget_4, self.tableWidget_5)
        QWidget.setTabOrder(self.tableWidget_5, self.pushButton_13)
        QWidget.setTabOrder(self.pushButton_13, self.pushButton_49)
        QWidget.setTabOrder(self.pushButton_49, self.pushButton_48)
        QWidget.setTabOrder(self.pushButton_48, self.pushButton_47)
        QWidget.setTabOrder(self.pushButton_47, self.pushButton_46)
        QWidget.setTabOrder(self.pushButton_46, self.pushButton_14)
        QWidget.setTabOrder(self.pushButton_14, self.comboBox_21)
        QWidget.setTabOrder(self.comboBox_21, self.comboBox_22)
        QWidget.setTabOrder(self.comboBox_22, self.dateEdit)
        QWidget.setTabOrder(self.dateEdit, self.tableWidget_6)
        QWidget.setTabOrder(self.tableWidget_6, self.pushButton_15)
        QWidget.setTabOrder(self.pushButton_15, self.lineEdit_29)
        QWidget.setTabOrder(self.lineEdit_29, self.tableWidget_7)
        QWidget.setTabOrder(self.tableWidget_7, self.pushButton_16)
        QWidget.setTabOrder(self.pushButton_16, self.lineEdit)
        QWidget.setTabOrder(self.lineEdit, self.comboBox)
        QWidget.setTabOrder(self.comboBox, self.comboBox_2)
        QWidget.setTabOrder(self.comboBox_2, self.tableWidget)
        QWidget.setTabOrder(self.tableWidget, self.tabWidget)
        QWidget.setTabOrder(self.tabWidget, self.pushButton_17)
        ...
        QWidget.setTabOrder(self.pushButton_22, self.textEdit)
