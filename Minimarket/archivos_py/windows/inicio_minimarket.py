from PySide6.QtWidgets import QMainWindow, QPushButton, QLineEdit, QDialog, QVBoxLayout, QComboBox, QTableWidget, QLabel, QApplication, QDoubleSpinBox, QTableWidgetItem, QApplication, QAbstractButton, QMessageBox, QCheckBox, QDateEdit, QTextEdit, QWidget
from PySide6.QtCore import QTimer, Qt, QDate, QObject
...
class DatosTab(QObject):
    ...
    def inicializar_ui_con_datos(self):
        ...
        table_widget2 = self.ui.frame_33.findChild(QTableWidget, "tableWidget_2")
        if table_widget2:
...
#################
    ...
    def ventana_borrar_productos(self):
        ...
        button29 = self.ui.frame_19.findChild(QPushButton, "pushButton_29")
        if button29:
            try:
                button29.clicked.disconnect()
            except Exception:
                pass
            button29.setStyleSheet("background-color: red; padding: 5px;")
            button29.clicked.connect(self.delete_product)


        #labels de borrar productos

        label_122 = self.ui.frame_19.findChild(QLabel, "label_122")
        if label_122:
            if label_122.text() != "Producto no encontrado":
                label_122.setStyleSheet("color: transparent")
    ...
    def delete_product(self):
        ...
        input_nombre_o_id = self.ui.frame_19.findChild(QLineEdit, "lineEdit_12")
        input_nombre_o_id_value = input_nombre_o_id.text().strip()

        if not input_nombre_o_id_value:
            self._borrar_producto = False
            if label_122:
                label_122.setText("Complete el campo")
                label_122.setStyleSheet("color: red; font-weight: bold")
            if button29:
            ...
            if producto:
                ...
                if self.show_delete_product_warning(self._borrar_nombre):
                    ...
                    if button29:
                        button29.setEnabled(True)
                    if label_122:
                        label_122.setText("Operación cancelada")
                        label_122.setStyleSheet("color: blue; font-weight: bold")
                    input_nombre_o_id.setFocus()
                return
            else:
                self._borrar_producto = False
                ...
                if button29:
                    button29.setEnabled(True)
                if label_122:
                    label_122.setText("Producto no encontrado")
                    label_122.setStyleSheet("color: red; font-weight: bold")
                input_nombre_o_id.setFocus()
        else:
            # Buscar por nombre
    ...
    def show_delete_product_warning(self, nombre_producto):
        msg = QMessageBox(self.ui.frame_19)
    ...
    def _on_nombre_obtenido(self, nombre_producto):
        ...
        label_122 = self.ui.frame_19.findChild(QLabel, "label_122")
        if label_122:
            label_122.setText("Borrando producto...")
            label_122.setStyleSheet("color: green; font-weight: bold")
    ...
    def on_producto_borrado(self):
        ...
        if label_122:
            label_122.setText("Producto borrado con éxito")
            label_122.setStyleSheet("color: green; font-weight: bold")
            QTimer.singleShot(6000, lambda: label_122.setStyleSheet("color: transparent"))
    ...
    def clear_inputs_borrar_productos(self):
        input_nombre = self.ui.frame_19.findChild(QLineEdit, "lineEdit_12")
        if input_nombre:
            input_nombre.clear()
            input_nombre.setFocus()
...
#################                
    ...
    def edit_product_by_id(self):
        ...
        boton_editar = self.ui.frame_9.findChild(QPushButton, "pushButton_25")
        if boton_editar:
        ...
        boton_cancelar = self.ui.frame_9.findChild(QPushButton, "pushButton_26")
        if boton_cancelar:
            boton_cancelar.clicked.connect(self.boton_cancelar)

        # Labels
        label_123 = self.ui.frame_9.findChild(QLabel, "label_123")
        label_124 = self.ui.frame_9.findChild(QLabel, "label_124")
        if label_123 and label_124:
            label_124.setStyleSheet("color: transparent")
            label_123.setStyleSheet("color: transparent")
        ...
        if combobox_9:
            ...
            combobox_9.currentIndexChanged.connect(self.update_combobox_8)
        ...
        doublespinbox1 = self.ui.frame_10.findChild(QDoubleSpinBox, "doubleSpinBox")
        if doublespinbox1:
            doublespinbox1.valueChanged.connect(self.update_spinbox_value)

        pushbutton_28 = self.ui.frame_10.findChild(QPushButton, "pushButton_28")
        if pushbutton_28:
            pushbutton_28.setEnabled(True)
            pushbutton_28.clicked.connect(self.update_product_prices)
        ...
        if combobox_11:
            ...
            combobox_11.currentIndexChanged.connect(self.update_combobox_10)
        ...
        doublespinbox_3 = self.ui.frame_14.findChild(QDoubleSpinBox, "doubleSpinBox_3")
        if doublespinbox_3:
            doublespinbox_3.valueChanged.connect(self.update_spinbox_bajar_value)

        push_button_14 = self.ui.frame_14.findChild(QPushButton, "pushButton_27")
        if push_button_14:
            push_button_14.setEnabled(True)
            push_button_14.clicked.connect(self.bajar_product_prices)
    ...
    def bajar_product_prices(self):
        ...
        push_button_27 = self.ui.frame_14.findChild(QPushButton, "pushButton_27")
        if push_button_27:
        ...
        combobox_11_value = combobox_11.currentText()
        combobox_10_value = combobox_10.currentText()

        if combobox_11_value == "Categoría":
            self.bajar_thread = BajarPreciosCategoriaThread(self.id_usuario_perfil, doublespinbox_value_3, doublespinbox_value_4, combobox_10_value)
            s = True
        else:
            self.bajar_thread = BajarPreciosProveedorThread(self.id_usuario_perfil, doublespinbox_value_3, doublespinbox_value_4, combobox_10_value)
            s = False
        ...
        def on_bajar_finalizado():
            ...
            if doublespinbox_value_3 != 0.00 or doublespinbox_value_4 != 0.00:
                ...
                self.movimiento_thread = MovimientoBajarPreciosThread(self.id_usuario_perfil, combobox_10_value, usuario_activo, s)
    ...
    def update_combobox_10(self):
        combobox_11 = self.ui.frame_14.findChild(QComboBox, "comboBox_11")
        combobox_10 = self.ui.frame_14.findChild(QComboBox, "comboBox_10")
        if combobox_11 and combobox_10:
            combobox_10.clear()
            if combobox_11.currentText() == "Categoría":
                self.populate_combobox_with_categorias(combobox_10)
            elif combobox_11.currentText() == "Proveedor":
                self.populate_combobox_with_proveedores(combobox_10)
    ...
    def update_spinbox_value(self):
        doublespinbox = self.ui.frame_10.findChild(QDoubleSpinBox, "doubleSpinBox")
        doublespinbox_2 = self.ui.frame_10.findChild(QDoubleSpinBox, "doubleSpinBox_2")
        doublespinbox_value = doublespinbox.value()

        if doublespinbox_2:
            doublespinbox_2.setValue(doublespinbox_value)

    def update_combobox_8(self):
        combobox_9 = self.ui.frame_10.findChild(QComboBox, "comboBox_9")
        combobox_8 = self.ui.frame_10.findChild(QComboBox, "comboBox_8")
        if combobox_9 and combobox_8:
            combobox_8.clear()
            if combobox_9.currentText() == "Categoría":
                self.populate_combobox_with_categorias(combobox_8)
            elif combobox_9.currentText() == "Proveedor":
                self.populate_combobox_with_proveedores(combobox_8)
    ...
    def update_product_prices(self):
        ...
        combobox_9_value = combobox_9.currentText()
        combobox_8_value = combobox_8.currentText()

        if combobox_9_value == "Categoría":
            self.aumentar_thread = AumentarPreciosCategoriaThread(self.id_usuario_perfil, doublespinbox_value, doublespinbox_2_value, combobox_8_value)
            s = True
        else:
            self.aumentar_thread = AumentarPreciosProveedorThread(self.id_usuario_perfil, doublespinbox_value, doublespinbox_2_value, combobox_8_value)
            s = False
    ...
    def load_product_data(self):
        ...
        if combobox_id:
            ...
            if selected_id and selected_id.isdigit():
                ...
                self.ui.frame_9.findChild(QLineEdit, "lineEdit_11").clear()
                self.ui.frame_9.findChild(QLineEdit, "lineEdit_10").clear()
                self.ui.frame_9.findChild(QLineEdit, "lineEdit_8").clear()
                self.ui.frame_9.findChild(QLineEdit, "lineEdit_9").clear()
                self.ui.frame_9.findChild(QLineEdit, "lineEdit_13").clear()
    ...
    def _on_producto_por_id_obtenido(self, producto, selected_id, combobox_id):
        ...
        if producto and selected_id == str(producto[0]):
            ...
            self.ui.frame_9.findChild(QLineEdit, "lineEdit_11").setText(producto[1])
            self.ui.frame_9.findChild(QLineEdit, "lineEdit_10").setText(str(producto[2]))
            self.ui.frame_9.findChild(QLineEdit, "lineEdit_8").setText(str(producto[3]))
            self.ui.frame_9.findChild(QLineEdit, "lineEdit_9").setText(str(producto[4]))
            self.ui.frame_9.findChild(QLineEdit, "lineEdit_13").setText(str(producto[5]))
            ...
            label_124 = self.ui.frame_9.findChild(QLabel, "label_124")
            if label_123 and label_124:
                label_123.setText("Seleccione o escriba")
                label_123.setStyleSheet("color: red; font-weight: bold")
                label_124.setText("un ID válido")
                label_124.setStyleSheet("color: red; font-weight: bold")
                QTimer.singleShot(6000, lambda: label_123.setStyleSheet("color: transparent"))
                QTimer.singleShot(6000, lambda: label_124.setStyleSheet("color: transparent"))
    ...
    def on_producto_actualizado(self):
        ...
        label_124 = self.ui.frame_9.findChild(QLabel, "label_124")
        if label_123 and label_124:
            label_123.setText("Producto actualizado")
            label_123.setStyleSheet("color: green; font-weight: bold")
            label_124.setText("con éxito")
            label_124.setStyleSheet("color: green; font-weight: bold")
            QTimer.singleShot(6000, lambda: label_123.setStyleSheet("color: transparent"))
            QTimer.singleShot(6000, lambda: label_124.setStyleSheet("color: transparent"))
    ...
    def verifica_datos_iguales(self, producto):
        ...
        if producto:
            if (self.ui.frame_9.findChild(QLineEdit, "lineEdit_11").text() == producto[1] and
                self.ui.frame_9.findChild(QLineEdit, "lineEdit_10").text() == str(producto[2]) and
                self.ui.frame_9.findChild(QLineEdit, "lineEdit_8").text() == str(producto[3]) and
                self.ui.frame_9.findChild(QLineEdit, "lineEdit_9").text() == str(producto[4]) and
                self.ui.frame_9.findChild(QLineEdit, "lineEdit_13").text() == str(producto[5]) and
                self.ui.frame_9.findChild(QComboBox, "comboBox_5").currentText() == producto[6] and
                self.ui.frame_9.findChild(QComboBox, "comboBox_6").currentText() == producto[7]):

                label_123 = self.ui.frame_9.findChild(QLabel, "label_123")
                label_124 = self.ui.frame_9.findChild(QLabel, "label_124")
                if label_123 and label_124:
                    label_123.setText("Por favor, edite")
                    label_123.setStyleSheet("color: red; font-weight: bold")
                    label_124.setText("los campos")
                    label_124.setStyleSheet("color: red; font-weight: bold")

                self.editando = False
                    

            elif not (self.is_decimal(self.ui.frame_9.findChild(QLineEdit, "lineEdit_10").text()) and
                self.is_decimal(self.ui.frame_9.findChild(QLineEdit, "lineEdit_8").text()) and
                self.is_decimal(self.ui.frame_9.findChild(QLineEdit, "lineEdit_9").text()) and
                self.is_decimal(self.ui.frame_9.findChild(QLineEdit, "lineEdit_13").text())):
                ...
                if label_123 and label_124:
                    label_123.setText("Por favor, ingrese")
                    label_123.setStyleSheet("color: red; font-weight: bold")
                    label_124.setText("valores válidos")
                    label_124.setStyleSheet("color: red; font-weight: bold")
                ...
                pushbutton_27 = self.ui.frame_14.findChild(QPushButton, "pushButton_27")
                if pushbutton_27:
                ...
                if label_123 and label_124:
                    label_123.setStyleSheet("color: green; font-weight: bold")
                    label_124.setStyleSheet("color: green; font-weight: bold")
                    label_123.setText("Actualizando")
                    label_124.setText("producto...")
                   

                self.edit_product(
                    producto_selecc[0],
                    self.ui.frame_9.findChild(QLineEdit, "lineEdit_11").text().strip(),
                    self.ui.frame_9.findChild(QLineEdit, "lineEdit_10").text().strip(),
                    self.ui.frame_9.findChild(QLineEdit, "lineEdit_8").text().strip(),
                    self.ui.frame_9.findChild(QLineEdit, "lineEdit_9").text().strip(),
                    self.ui.frame_9.findChild(QLineEdit, "lineEdit_13").text().strip(),
                    self.ui.frame_9.findChild(QComboBox, "comboBox_5").currentText(),
                    self.ui.frame_9.findChild(QComboBox, "comboBox_6").currentText()
                )
...
################
    ...
    def agregar_proveedor(self):
        ...
        button_30 = self.ui.frame_20.findChild(QPushButton, "pushButton_30") #pushbutton26 boton agregar
        if button_30:
    ...
    def clear_inputs_agregar_proveedores(self):
        lineEdit_16 = self.ui.frame_20.findChild(QLineEdit, "lineEdit_16")
        lineEdit_14 = self.ui.frame_20.findChild(QLineEdit, "lineEdit_14")
        lineEdit_15 = self.ui.frame_20.findChild(QLineEdit, "lineEdit_15")

        if lineEdit_14 and lineEdit_15 and lineEdit_16:            
            lineEdit_14.clear()
            lineEdit_15.clear()
            lineEdit_16.clear()
    ...
    def validate_and_process_inputs_proveedores(self):
        ...
        lineEdit_16 = self.ui.frame_20.findChild(QLineEdit, "lineEdit_16")  # Nombre
        lineEdit_14 = self.ui.frame_20.findChild(QLineEdit, "lineEdit_14")  # Teléfono
        lineEdit_15 = self.ui.frame_20.findChild(QLineEdit, "lineEdit_15")  # Dirección

        button_30 = self.ui.frame_20.findChild(QPushButton, "pushButton_30")
        button_31 = self.ui.frame_20.findChild(QPushButton, "pushButton_31")
        if button_30:
        ...
        if lineEdit_14 and lineEdit_15 and lineEdit_16:
            ...
            existe_nombre = proveedores_por_nombre_cache and lineEdit_16_value.lower() in proveedores_por_nombre_cache
            ...
            if existe_nombre or existe_telefono:
                ...
                if lineEdit_16_value and lineEdit_14_value.isdigit():
                    ...
                    self.proveedor_thread = ProveedorThread(self.id_usuario_perfil, lineEdit_16_value, lineEdit_14_value, lineEdit_15_value)
                    ...
                    if not lineEdit_16_value:
                        lineEdit_16.setFocus()
                    elif not lineEdit_14_value.isdigit():
...
################
    ...
    def editar_proveedor(self):
        ...
        if combobox_nombre:
            ...
            combobox_nombre.setMaxVisibleItems(5)
    ...
    def update_proveedor(self):
        ...
        combobox_nombre = self.ui.frame_24.findChild(QComboBox, "comboBox_12")
        lineEdit_17 = self.ui.frame_24.findChild(QLineEdit, "lineEdit_17")
        lineEdit_18 = self.ui.frame_24.findChild(QLineEdit, "lineEdit_18")
        comboBox_value = combobox_nombre.currentText()
        lineEdit_17_value = lineEdit_17.text().strip()
        lineEdit_18_value = lineEdit_18.text().strip()

        label_120 = self.ui.frame_24.findChild(QLabel, "label_120")

        if comboBox_value and lineEdit_17_value.isdigit():
            if (lineEdit_17_value != str(proveedor_selecc[0][1]) or lineEdit_18_value != str(proveedor_selecc[0][2])) and comboBox_value == proveedor_selecc[0][0]:
                
                label_120 = self.ui.frame_24.findChild(QLabel, "label_120")
                if label_120:
                    label_120.setStyleSheet("color: green; font-weight: bold")
                    label_120.setText("Actualizando")

                self.actualizar_prov_thread = ActualizarProveedorThread(self.id_usuario_perfil, comboBox_value, lineEdit_17_value, lineEdit_18_value)
                def on_actualizado(exito):
                    ...
                    if exito:
                        ...
                        if label_120:
                            label_120.setStyleSheet("color: green; font-weight: bold")
                            label_120.setText("Proveedor actualizado con éxito")
                        ...
                        if button_32:
                            button_32.setEnabled(True)
                        if button_33:
                            button_33.setEnabled(True)
                ...
                if label_120:
                    label_120.setText("No se realizaron cambios")
            ...
            # redireccion para el linedit q falte o este mal escrito
            if not comboBox_value:
                combobox_nombre.setFocus()
            elif not lineEdit_17_value.isdigit():
                lineEdit_17.setFocus()

    def clear_inputs_editar_proveedores(self):
        lineEdit_17 = self.ui.frame_24.findChild(QLineEdit, "lineEdit_17")
        lineEdit_18 = self.ui.frame_24.findChild(QLineEdit, "lineEdit_18")
        comboBox_12 = self.ui.frame_24.findChild(QComboBox, "comboBox_12")
        if lineEdit_17 and lineEdit_18:
            lineEdit_17.clear()
            lineEdit_18.clear()
    ...
    def load_proveedor_data(self):
        ...
        if combobox_nombre and (combobox_nombre.currentText() != ""):
            ...
            if selected_nombre and proveedores_por_nombre_cache and selected_nombre.lower() in proveedores_por_nombre_cache:
                ...
                if label_120:
                    label_120.setStyleSheet("color: transparent")
                    label_120.setText("Proveedor existente")

                self.ui.frame_24.findChild(QComboBox, "comboBox_12").setCurrentText(proveedor_selecc[0][0])
                self.ui.frame_24.findChild(QLineEdit, "lineEdit_17").setText(str(proveedor_selecc[0][1]))
                self.ui.frame_24.findChild(QLineEdit, "lineEdit_18").setText(str(proveedor_selecc[0][2]))
            else:
                try:
                    self.ui.frame_24.findChild(QLineEdit, "comboBox_12").clear()
                    self.ui.frame_24.findChild(QLineEdit, "lineEdit_17").clear()
                    self.ui.frame_24.findChild(QLineEdit, "lineEdit_18").clear()
                except:
                    if label_120:
                        label_120.setStyleSheet("color: red; font-weight: bold")
                        label_120.setText("Seleccione o escriba un proveedor existente")
...
################
    ...
    def populate_table_with_proveedores(self):
        ...
        label_67 = self.ui.frame_33.findChild(QLabel, "label_67")
        if label_67:
            label_67.clear()
            label_67.setText(f"{cantidad_proveedores}")

        table_widget = self.ui.frame_33.findChild(QTableWidget, "tableWidget_2")
        if table_widget:
...
################
    ...
    def editar_usuario(self):
        label_113 = self.ui.frame_48.findChild(QLabel, "label_113")
        label_114 = self.ui.frame_48.findChild(QLabel, "label_114")
        combobox_14 = self.ui.frame_48.findChild(QComboBox, "comboBox_14")
        combobox_15 = self.ui.frame_48.findChild(QComboBox, "comboBox_15")
        push_button_42 = self.ui.frame_48.findChild(QPushButton, "pushButton_42") #31
        push_button_41 = self.ui.frame_48.findChild(QPushButton, "pushButton_41") #35
        push_button_43 = self.ui.frame_48.findChild(QPushButton, "pushButton_43") #41
        ...
        if combobox_15:
            ...
            self.populate_combobox_with_names(combobox_15)  # Llenar el combobox con los nombres de usuarios
            
        if push_button_43:
            try:
                push_button_43.clicked.disconnect()
            except Exception:
                pass
            push_button_43.setFocusPolicy(Qt.NoFocus)
            push_button_43.setIcon(QIcon(eye_visible_path))
            push_button_43.clicked.connect(self.setear_lineedit_avisual_editar)

        if label_113:
            label_113.setStyleSheet("color: transparent")
            label_113.setText("")

        if label_114:
            label_114.setStyleSheet("color: transparent")
            label_114.setText("")

        if push_button_42:
            push_button_42.setFocusPolicy(Qt.NoFocus)
            push_button_42.setStyleSheet("background-color: rgb(255, 202, 96)")
            push_button_42.setShortcut(Qt.Key_Return)
            push_button_42.clicked.connect(lambda: self.validar_datos_iguales_usuario(usuario_selecc if usuario_selecc is not None else None))
        if push_button_41:
            push_button_41.setFocusPolicy(Qt.NoFocus)
            push_button_41.clicked.connect(self.clear_inputs_editar_usuario)

        if line_edit_28:
            line_edit_28.setEchoMode(QLineEdit.Password)
    ...
    def load_user_data(self):
        ...
        combobox_15 = self.ui.frame_48.findChild(QComboBox, "comboBox_15")
        if combobox_15:
            nombre = combobox_15.currentText()
            if nombre and usuarios_por_nombre_cache and nombre in usuarios_por_nombre_cache:
                ...
                if usuario and nombre == str(usuario[1]):
                    if usuario[3]:  # admin (bool)
                        self.ui.frame_48.findChild(QComboBox, "comboBox_14").setCurrentIndex(0)
                    else:
                        self.ui.frame_48.findChild(QComboBox, "comboBox_14").setCurrentIndex(1)
                    self.ui.frame_48.findChild(QComboBox, "comboBox_15").setCurrentText(str(usuario[1]))
                    self.ui.frame_48.findChild(QLineEdit, "lineEdit_28").setText(str(usuario[4]))  # passsword 28
                    self.ui.frame_48.findChild(QLineEdit, "lineEdit_30").setText(str(usuario[2]))  # email 30
    ...
    def validar_datos_iguales_usuario(self, usuario_selecc):
        ...
        if usuario_selecc:
            combobox_14 = self.ui.frame_48.findChild(QComboBox, "comboBox_14")
            line_edit_28 = self.ui.frame_48.findChild(QLineEdit, "lineEdit_28")  # contraseña
            line_edit_30 = self.ui.frame_48.findChild(QLineEdit, "lineEdit_30")  # email

            value_line_edit_28 = line_edit_28.text().strip()  # contraseña
            value_combobox_14 = combobox_14.currentText()
            value_combobox_14 = True if value_combobox_14 == "Administrador" else False
            
            # Comparar admin y contraseña Y email
            if usuario_selecc[0][3] == value_combobox_14 and str(usuario_selecc[0][4]) == str(value_line_edit_28) and str(usuario_selecc[0][2]).strip() == line_edit_30.text().strip():
                label_114.setStyleSheet("color: red; font-weight: bold")
                label_113.setStyleSheet("color: red; font-weight: bold")
                label_113.setText("Porfavor, edite")
                label_114.setText("los campos")
            else:
    ...
    def validar_editar_usuario(self):
        ...
        push_button_42 = self.ui.frame_48.findChild(QPushButton, "pushButton_42")
        push_button_41 = self.ui.frame_48.findChild(QPushButton, "pushButton_41")

        combobox_14 = self.ui.frame_48.findChild(QComboBox, "comboBox_14")
        line_edit_28 = self.ui.frame_48.findChild(QLineEdit, "lineEdit_28")  # mail
        line_edit_30 = self.ui.frame_48.findChild(QLineEdit, "lineEdit_30")  # contraseña
        value_line_edit_30 = line_edit_30.text().strip()  # contraseña
        value_combobox_14 = combobox_14.currentText()
        value_line_edit_28 = line_edit_28.text().strip()  # mail
        label_113 = self.ui.frame_48.findChild(QLabel, "label_113")
        label_114 = self.ui.frame_48.findChild(QLabel, "label_114")
        combobox_15 = self.ui.frame_48.findChild(QComboBox, "comboBox_15")
        value_combobox_15 = combobox_15.currentText().strip()

        # Validar que la contraseña tenga al menos 8 caracteres
        if len(value_line_edit_28) <= 8:
            self._actualizar_usuario_en_proceso = False
            label_114.setStyleSheet("color: red; font-weight: bold")
            label_113.setStyleSheet("color: red; font-weight: bold")
            label_113.setText("La contraseña debe tener")
            label_114.setText("al menos 8 caracteres")
           
            line_edit_28.setFocus()
            line_edit_28.selectAll()
            return

        # Validar si el email ya existe en otro usuario (excepto el usuario actual)
        if any(u[2].strip().lower() == value_line_edit_30.lower() and u[0] != usuario_selecc[0][0] for u in usuarios):
            self._actualizar_usuario_en_proceso = False
            label_113.setText("El email ya está en uso")
            label_114.setText("por otro usuario")
            label_114.setStyleSheet("color: red; font-weight: bold")
            label_113.setStyleSheet("color: red; font-weight: bold")
            line_edit_30.setFocus()
            line_edit_30.selectAll()
            return

        if label_113 and label_114:
            label_114.setStyleSheet("color: green; font-weight: bold")
            label_113.setStyleSheet("color: green; font-weight: bold")
            label_113.setText("Actualizando")
            label_114.setText("usuario...")
        self.actualizar_usuario_thread = ActualizarUsuarioThread(self.id_usuario_perfil,
            usuario_selecc[0][0], value_combobox_15, value_line_edit_28, value_line_edit_30
        )
        def on_actualizado(s):
            if s:
                self.movimiento_thread = CargarMovimientoEditarUsuarioThread(self.id_usuario_perfil,
                    usuario_selecc[0][0], value_combobox_15, usuario_activo
                )
                self.start_thread(self.movimiento_thread)
                ...
                label_113.setText("Usuario")
                label_114.setText("actualizado")
                label_114.setStyleSheet("color: green; font-weight: bold")
                label_113.setStyleSheet("color: green; font-weight: bold")
                QTimer.singleShot(6000, lambda: label_113.setStyleSheet("color: transparent"))
                QTimer.singleShot(6000, lambda: label_114.setStyleSheet("color: transparent"))

                if push_button_42:
                    push_button_42.setEnabled(True)
                if push_button_41:
                    push_button_41.setEnabled(True)
    ...
    def setear_lineedit_avisual_editar(self):
        line_edit_28 = self.ui.frame_48.findChild(QLineEdit, "lineEdit_28")
        if line_edit_28:
            if line_edit_28.echoMode() == QLineEdit.Password:
                line_edit_28.setEchoMode(QLineEdit.Normal)
            else:
                line_edit_28.setEchoMode(QLineEdit.Password)
...
class MainWindow(QMainWindow):
    ...
    def resizeEvent(self, event):
        ...
        # Si existe la ventana flotante, actualizar su posición
        if hasattr(self, 'datos_tab') and hasattr(self.datos_tab, '_ventana_estado_ventas') and self.datos_tab._ventana_estado_ventas:
            self.datos_tab.mover_ventana_estado_ventas()
